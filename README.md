...
6. Add a tag and push to origin such as `git tag v1.0.3 && git push origin v1.0.3`
7. Visit [https://github.com/ably/ably-ruby/tags](https://github.com/ably/ably-ruby/tags) and `Add release notes` for the release including links to the changelog entry.
8. Run `rake release` to publish the gem to [Rubygems](https://rubygems.org/gems/ably)
9. Release the [REST-only library `ably-ruby-rest`](https://github.com/ably/ably-ruby-rest#release-process)
