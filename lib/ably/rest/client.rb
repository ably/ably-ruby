...
module Ably
  module Rest
    ...
    class Client
      ...
      # @return [Boolean]
      attr_reader :log_exception_reporting
      ...
      # The log exception reporting service instance.
      # @return [Ably::Reporting::Base, nil]
      attr_reader :log_exception_reporting_service
      ...
      # @option options [Ably::Reporting::Service,Nil] :log_exception_reporting_class Log exception reporting class. By default it is Ably::Reporting::Sentry
      ...
      def initialize(options)
        ...
        @log_exception_reporting = true
        if options.has_key?(:log_exception_reporting_url)
          @log_exception_reporting_url = options.delete(:log_exception_reporting_url)
          @log_exception_reporting = !@log_exception_reporting_url.nil? && @log_exception_reporting_url
        end

        if @log_exception_reporting
          log_exception_reporting_options = { dsn: @log_exception_reporting_url }
          if options.has_key?(:log_exception_reporting_class)
            log_exception_reporting_class = options.delete(:log_exception_reporting_class)
            @log_exception_reporting_service = log_exception_reporting_class.new(log_exception_reporting_options)
            unless @log_exception_reporting_service.respond_to?(:capture_exception)
              raise ArgumentError, 'log_exception_reporting_service does not respond to capture_exception() method'
            end
          else
            @log_exception_reporting_service = Ably::Reporting::Service.new(log_exception_reporting_options)
          end
        end
