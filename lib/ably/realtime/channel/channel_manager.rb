  ...
  module Realtime
    class Channel
      ...
      class ChannelManager
        ...
        # Commence attachment
        def attach
          return unless can_transition_to?(:attached)
        ...
        def attached(attached_protocol_message)
          ...
          return unless attached_protocol_message
        ...
        def fail_messages_in_queue(queue, error)
          queue.delete_if do |protocol_message|
            if protocol_message.action.match_any?(:presence, :message) && protocol_message.channel == channel.name
        ...
        attr_reader :pending_state_change_timer, :channel, :connection

        def_delegators :channel, :can_transition_to?

        def cancel_attach_from_suspended_timer
          @attach_from_suspended_timer&.cancel
        ...
        def send_attach_protocol_message
          ...
          message_options[:flags] = message_options[:flags].to_i | Ably::Models::ProtocolMessage::ATTACH_FLAGS_MAPPING[:resume] if channel.attach_resume
