...
module Ably
  ...
  module Models
    ...
    class ConnectionDetails
      ...
      # Max frame size
      MAX_FRAME_SIZE = 524_288 # See spec TO3l9
      ...
      def initialize(attributes = {})
        ...
        %I[connection_state_ttl max_idle_interval].each do |duration_field|
          self.attributes[duration_field] = (self.attributes[duration_field].to_f / 1000).round if self.attributes[duration_field]
        end
